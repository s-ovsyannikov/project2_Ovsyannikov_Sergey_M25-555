...
def print_help():
    ...
    print("- Автоматическая обработка ошибок")
    print("- Подтверждение опасных операций")
    print("- Кэширование запросов для ускорения")
    print("- Замер времени выполнения операций\n")
